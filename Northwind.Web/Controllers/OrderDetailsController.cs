...
namespace Northwind.Web.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(NorthwindContext context, IServiceManager serviceContext)
        {
            _context = context;
        ...
        {
            var orderDetailsDto = await _serviceContext.OrderDetailsService.GetAllOrderDetail(false);
